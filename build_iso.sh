...
# FIXME
docker run --rm -i --privileged -v $(pwd):/code/ docker.mgm.sipwise.com/deployment-iso-buster:I67e3f85bbe86bd1b3ee709161504b5250ca5d7fe /code/t/iso-tester /code/artifacts/${SIPWISE_ISO} /code/artifacts/memtest.jpg /code/t/screenshots/01-memtest.jpg
