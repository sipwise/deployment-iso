...
set_up_partition_table_swraid() {
  ...
  raidev1=$(blkid -t PARTLABEL="Linux RAID" -o device "${SWRAID_DISK1}*")
  raidev2=$(blkid -t PARTLABEL="Linux RAID" -o device "${SWRAID_DISK2}*")
...
if [[ "${SWRAID}" = "true" ]] ; then
  if efi_support ; then
    efidev1=$(blkid -t PARTLABEL="EFI System" -o device "${SWRAID_DISK1}*")
    efidev2=$(blkid -t PARTLABEL="EFI System" -o device "${SWRAID_DISK2}*")
