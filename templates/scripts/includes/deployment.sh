...
VIRTUALBOX_ISO="VBoxGuestAdditions_5.2.18.iso"
VIRTUALBOX_ISO_CHECKSUM="f98b6ad7093ee0b27d26dea565b197a5f33fdac93c4b67e73824ce889d6c964c" # sha256
...
vagrant_configuration() {
  ...
  rm -f /etc/systemd/system/multi-user.target.wants/vboxadd-service.service
  rm -f /etc/systemd/system/multi-user.target.wants/vboxadd.service
}
